...
**Everything is answered and this is ready to build.** It arrived at the end of
the queue while the owner worked through the questions below; they have, and it
comes back to the front.

**One thing is deliberately out of scope, by their decision.** With the falling
line no longer a threat, nothing in this fight can hurt the pair or hurry them
— the wave carries no other creatures. The owner has seen that and is thinking
about it separately: *ich mache mir darüber noch gedanken und setze das separat
um.* So do not invent pressure, a clock or a hazard to fill the gap. Build the
fight as described and leave the room for it.
