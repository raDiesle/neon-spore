...
| [bosses.md §11.15 THE REPRISE](bosses.md#1115-the-reprise--the-wave-you-have-just-beaten-sent-again-unseen) | **built, 17 September 2026** — **taken for the rehearsal, 18 September 2026** | the simulation and the look are shipped (wave `theReprise`, act 10, `render/src/reprise-draw.ts`). `claude/boss-implementation-e3cfff` is writing its rehearsal — the film of a stretch the pair can no longer see, answered from what they said about it while they could |
