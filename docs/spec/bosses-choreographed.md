...
- **[THE RATCHET](#22-the-ratchet--whether-a-step-can-be-taken-back)** · §22 — whether a step can be taken back. One of [five more](#five-more-asked-for-by-name); **lane one landed 23 September 2026** as [bosses](bosses.md) §11.38, wave 102; the picture landed the same day — the hands, the second half of lane two, are open
...
picture landed the same day** (§11.38, *The look*). **Not built:** the hands —
the hit tests and cue words for the catch and the pawl — which are a queue item
