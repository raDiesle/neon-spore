...
| [§10 THE BATON](#10-the-baton--whose-turn-is-it) | **built, 16 September 2026** — **taken again, 17 September 2026** | `claude/boss-implementation-e3cfff` — the simulation, then the look. Worked and written up as [bosses](bosses.md) §11.18 (wave 68). **Taken for the design's step 7 and the beam**, the two smallest of §11.18's *not built* — a shot at anything is her turn spent, and the lance beam meets the bead the way a bolt does; one simulation lane, no look. The second bead (step 9) and the merged final flight (steps 12–13) stay not built and untaken |
