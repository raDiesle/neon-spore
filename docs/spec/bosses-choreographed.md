...
| [§13 THE UNDERTOW](#13-the-undertow--where-you-are-being-hit-from) | **built, 17 September 2026** — **taken again, 17 September 2026** | `claude/boss-implementation-e3cfff` — the simulation, then the look: the plate bowing on player 1's screen alone, the lobe up through the plating, the body taken in. Worked and written up as [bosses](bosses.md) §11.20 (wave 69, THE UNDERTOW). **Taken again for what §11.20 lists as not built**, by the same lane, in two halves: the plate a tall lobe takes with it when it withdraws (step 9's *missed*, step 10's shorter hull) as a fact in the hull's record, then as a hole in the outline; then step 11's picture, the plate closing under a cannon slid off in time. |
