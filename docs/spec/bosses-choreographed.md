...
- **[THE CYST](#34-the-cyst--a-pulse-stilled-by-one-hand-so-the-other-can-close-it)** · §34 — a pulse stilled by one hand so the other can close it. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.51, wave 113 — the look is not written, and nothing sends a tap or a pinch from a touch yet
...
- **[THE CYST](#34-the-cyst--a-pulse-stilled-by-one-hand-so-the-other-can-close-it)** · §34 — a pulse stilled by one hand so the other can close it. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.51, wave 113; the touch sender and the look are queued, not yet claimed
