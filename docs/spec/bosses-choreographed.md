...
**Nothing here is built** but §28 THE VISE's simulation lane — [bosses](bosses.md)
§11.45, wave 107, its look queued. Same split as the batch above: a simulation lane
