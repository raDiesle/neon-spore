...
- **[THE VALVE](#25-the-valve--freezing-what-the-other-hand-is-already-moving)** · §25 — freezing what the other hand is already moving. One of [five more, both screens reading the same picture](#five-more-both-screens-reading-the-same-picture); **lane one landed 26 September 2026** as [bosses](bosses.md) §11.42, wave 104; the look's first half, the body, landed the same day — its second half, the hands, is queued
- **[THE SEAM](#26-the-seam--a-crack-the-cannon-answers-in-order-with-the-shield-in-between)** · §26 — a crack the cannon answers, in order, with the shield in between. One of [five more, both screens reading the same picture](#five-more-both-screens-reading-the-same-picture); **lane one landed 26 September 2026** as [bosses](bosses.md) §11.43, wave 105; the look's first half, the body, landed the same day — its second half, the hands, is queued
- **[THE OCULUS](#27-the-oculus--shutting-an-eye-together-then-answering-what-was-behind-it)** · §27 — shutting an eye together, then answering what was behind it. One of [five more, both screens reading the same picture](#five-more-both-screens-reading-the-same-picture); **lane one landed 26 September 2026** as [bosses](bosses.md) §11.44, wave 106; the look's first half, the body, landed the same day, and the on-field leaf holds, the autopilot hand, the receipts' fx and the cue's words and THE SLOW's aim after it — its look is done
- **[THE VISE](#28-the-vise--a-gap-two-thumbs-close-from-opposite-sides)** · §28 — a gap two thumbs close from opposite sides. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.45, wave 107; half one of the look, the body, landed the same day, and the pinch on the field, the autopilot hand and the fx of half two, THE SLOW's aim and the cue's words — the look is done
- **[THE RIME](#29-the-rime--a-level-nobody-has-to-hold-only-keep-re-reaching)** · §29 — a level nobody has to hold, only keep re-reaching. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.46, wave 108; half one of the look, the body, landed the same day — its second half, the hands, is queued
- **[THE TRIVET](#30-the-trivet--three-feet-each-planted-only-while-a-chord-holds)** · §30 — three feet, each planted only while a chord holds. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.47, wave 109; half one of the look, the body, landed the same day, and the chord on the field, the autopilot hand, THE SLOW's aim, the cue's words and the fx of half two — the lurch and the needle, which landed after it, were drawn the same day; the look is done but for row 11's ring, waiting on its revised simulation lane
- **[THE PLUMB](#31-the-plumb--a-lean-held-long-enough-to-bring-it-level)** · §31 — a lean held long enough to bring it level. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.48, wave 110, and its lean reader the same day; half one of the look, the body, landed the same day — its second half, the hands, is queued
- **[THE SLING](#32-the-sling--a-draw-held-long-enough-to-loose-it-aimed)** · §32 — a draw held long enough to loose it aimed. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.49, wave 111 — the look is not written, and nothing sends a draw from a touch yet
- **[THE GRINDSTONE](#33-the-grindstone--a-wheel-ground-true-then-held-true-by-a-locked-caliper)** · §33 — a wheel ground true, then held true by a locked caliper. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.50, wave 112 — the look is not written, and nothing sends a grind or a clamp from a touch yet
- **[THE CYST](#34-the-cyst--a-pulse-stilled-by-one-hand-so-the-other-can-close-it)** · §34 — a pulse stilled by one hand so the other can close it. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **built 26 September 2026** as [bosses](bosses.md) §11.51, wave 113 — both lanes, the look and the touch sender with it; no autopilot hand yet
- **[THE DAVIT](#35-the-davit--a-boom-one-hand-steers-for-the-other-to-loose)** · §35 — a boom one hand steers for the other to loose. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.52, wave 114, and the look landed the same day — the touch sender reuses THE PLUMB's lean and THE SLING's draw, the boom stands, swings and asks its halo, the hook lights a fire step's colour — the look is done; there is still no autopilot hand
- **[THE HALTER](#36-the-halter--a-seam-that-only-bares-itself-while-one-hand-proves-it-isnt-there)** · §36 — a seam that only bares itself while one hand proves it isn't there. One of [more, spent from the unclaimed gesture list](#more-spent-from-the-unclaimed-gesture-list), written 26 September 2026; **lane one landed 26 September 2026** as [bosses](bosses.md) §11.53, wave 115 — the look is not written, and nothing sends a grip from a touch yet
...
- **[THE VALVE](#25-the-valve--freezing-what-the-other-hand-is-already-moving)** · §25 — freezing what the other hand is already moving. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.42, wave 104; half one of the look, the body, landed the same day, and half two, the hands, is queued
- **[THE SEAM](#26-the-seam--a-crack-the-cannon-answers-in-order-with-the-shield-in-between)** · §26 — a crack the cannon answers, in order, with the shield in between. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.43, wave 105; half one of the look, the body, landed the same day, and half two, the hands, is queued
- **[THE OCULUS](#27-the-oculus--shutting-an-eye-together-then-answering-what-was-behind-it)** · §27 — shutting an eye together, then answering what was behind it. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.44, wave 106; half one of the look, the body, landed the same day, and the on-field leaf holds, the autopilot hand, the receipts' fx and the cue's words and THE SLOW's aim after it; its look is done
- **[THE VISE](#28-the-vise--a-gap-two-thumbs-close-from-opposite-sides)** · §28 — a gap two thumbs close from opposite sides. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.45, wave 107; half one of the look, the body, landed the same day, and the pinch on the field, the autopilot hand and the fx of half two, THE SLOW's aim and the cue's words; the look is done
- **[THE RIME](#29-the-rime--a-level-nobody-has-to-hold-only-keep-re-reaching)** · §29 — a level nobody has to hold, only keep re-reaching. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.46, wave 108; half one of the look, the body, landed the same day; half two, the hands, is queued
- **[THE TRIVET](#30-the-trivet--three-feet-each-planted-only-while-a-chord-holds)** · §30 — three feet, each planted only while a chord holds. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.47, wave 109; half one of the look, the body, landed the same day, and the chord on the field, the autopilot hand, THE SLOW's aim, the cue's words and the fx of half two; the lurch and the needle, which landed after it, were drawn the same day; the look is done but for row 11's ring, waiting on its revised simulation lane
- **[THE PLUMB](#31-the-plumb--a-lean-held-long-enough-to-bring-it-level)** · §31 — a lean held long enough to bring it level. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.48, wave 110, and the lean reader after it; half one of the look, the body, landed the same day; half two, the hands, is queued
- **[THE SLING](#32-the-sling--a-draw-held-long-enough-to-loose-it-aimed)** · §32 — a draw held long enough to loose it aimed. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.49, wave 111; the touch sender and the look are queued, not yet claimed
- **[THE GRINDSTONE](#33-the-grindstone--a-wheel-ground-true-then-held-true-by-a-locked-caliper)** · §33 — a wheel ground true, then held true by a locked caliper. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.50, wave 112; the touch sender and the look are queued, not yet claimed
- **[THE CYST](#34-the-cyst--a-pulse-stilled-by-one-hand-so-the-other-can-close-it)** · §34 — a pulse stilled by one hand so the other can close it. Built 26 September 2026 as [bosses](bosses.md) §11.51, wave 113, the look and the touch sender included
- **[THE DAVIT](#35-the-davit--a-boom-one-hand-steers-for-the-other-to-loose)** · §35 — a boom one hand steers for the other to loose. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.52, wave 114; the touch sender and the look landed the same day — the body, the halo and the lit hook are drawn; there is still no autopilot hand
- **[THE HALTER](#36-the-halter--a-seam-that-only-bares-itself-while-one-hand-proves-it-isnt-there)** · §36 — a seam that only bares itself while one hand proves it isn't there. Lane one landed 26 September 2026 as [bosses](bosses.md) §11.53, wave 115; the touch sender and the look are queued, not yet claimed
...
| [§33 THE GRINDSTONE](#33-the-grindstone--a-wheel-ground-true-then-held-true-by-a-locked-caliper) | **built, 26 September 2026** — both lanes; the autopilot hand and its own blow queued | The simulation is in as wave 112 THE GRINDSTONE and `docs/spec/bosses.md` §11.50: `grindFlatLeft` and `grindFlatRight` heard as THE RIME hears a half, the drag's `id` the reversals since the thumb went down, and `grindJawLeft` and `grindJawRight` heard as THE TRIVET hears a foot, one drag a pad by its `id`; one of each per seat by geometry, THE MANTLE's rule. A script authored on the wave of two passes a flat, the second from a film, then fire and `clamp` in turn; grit shaved per fresh reversal and regrown a beat nobody rubbed; both flats clean biting the caliper; a clamp counted on the beat with every pad of both jaws down and started again by one lifting; a fire step the ordinary shot into the middle column in its colour. Four passes and three hits as the health. **Eight departures are argued by name** in §11.50: a fire step run out is the wave, a clamp run out is asked again rather than a regrind, a clamp is given grace, two controls together is every pad of both jaws, the targets are named for the body, the caliper bites by itself, a pass run out rewinds to that flat's first, and the passes and the hits are the health together. The thirteen sounds are bound; nothing sends a grind or a clamp from a touch yet, nothing of it is drawn, and there is no autopilot hand |
| [§34 THE CYST](#34-the-cyst--a-pulse-stilled-by-one-hand-so-the-other-can-close-it) | **lane one landed, 26 September 2026** — the touch sender and lane two open | The simulation is in as wave 113 THE CYST and `docs/spec/bosses.md` §11.51: `cystFreezeLeft` and `cystFreezeRight` heard as THE VALVE hears its pin, an edge, and `cystFlankLeft` and `cystFlankRight` heard as THE VISE hears a lobe, `fromMilli` the gap; each side's two on different seats, the freezing hand always the pinching hand's partner. A script authored on the wave of a flank a seat, then fire and a guard in turn; a lit flank waits for the partner's tap, and only a stilled flank's pinch is counted; both flanks cracked bare the core; a guard is a flank step on a cracked flank, and one run out reseals the core; a fire step the ordinary shot into the middle column in its colour. Two cracks and three hits as the health. **The story steps landed 26 September 2026**: a swell both pinch shut together, a spore spat off the middle and turned by the shield, and a bud shot in its colour off the middle, each under THE SLOW and each run out a hull hit — eleven steps in all. **Eight departures are argued by name** in §11.51: the shudder is a rule rather than a field, a tap and its pinch are one step, a pinch is given grace, a pinch already shut counts from the tap, a guard is one flank at a time, a guard run out is asked again, a fire step run out is the wave, and the targets are named for the body with THE SLOW off a shot. The seventeen sounds are bound. **The look landed the same day** (`render/cyst-*.ts`): BULB · CLOVER, the same sac on both phones, a lit flank shuddering white beside its breathing mark, stopped dead on the tap, cracking as the pinch holds, a swell, a spore and a bud each drawn, the core bared and lit in its colour, and `TAP`, `SHUT` and `FIRE` as its words; a tap and a pinch are sent from a touch (`cyst-grip.ts`). There is no autopilot hand, and its timeout is the default lash |
| [§35 THE DAVIT](#35-the-davit--a-boom-one-hand-steers-for-the-other-to-loose) | **lane one landed, 26 September 2026**; lane two, the look, landed the same day — the look is done; there is still no autopilot hand | The simulation is in as wave 114 THE DAVIT and `docs/spec/bosses.md` §11.52: `davitSteerLeft` and `davitSteerRight` heard as THE PLUMB hears a weight, `fromMilli` the lean, and `davitLooseLeft` and `davitLooseRight` heard as THE SLING hears an arm, the lift carrying the swipe; the pilot has the left pair and the navigator the right, and which of a seat's two is live is the step's — on the left swing the pilot steers and the navigator looses, on the right swing the other way about, on a reland either. A draw counts its beats only while the other seat's lean holds the step's target, and lands only if it lifts while the lean still holds, swiped toward the target's half; two looses a swing light the pivot, a fire step the ordinary shot into the middle column in its colour. Two swings and three hits as the health. **Seven departures are argued by name** in §11.52: the column is a signed target lean, drawn is counted in beats, either seat steers a reland, a swing run out is tried again from the same step, a reland run out dims the pivot and is asked again, a fire step run out is the wave, and row 9's "faster" is left to the look. The thirteen sounds are bound. Lane two, the look, landed 26 September 2026 (`render/davit-shape.ts`, `davit-pose.ts`, `davit-draw.ts`, `davit-marks.ts`, `davit-blow.ts`, `davit-grip.ts`, `test/davit-frame.test.ts`): a steel boom stands off a mast over the middle column, swinging toward the live lean; a halo rings it while a lean is asked for, and the hook lights a fire step's colour with a ring that closes as the window runs out; a window run out breaks the hull with the boom's own blow, the hook paying its chain out and hauled back taut. The touch sender is THE PLUMB's lean, generalised, and THE SLING's draw, unchanged (`apps/game/src/lean.ts`). There is still no autopilot hand |
| [§36 THE HALTER](#36-the-halter--a-seam-that-only-bares-itself-while-one-hand-proves-it-isnt-there) | **lane one landed, 26 September 2026** — the touch sender and lane two open | The simulation is in as wave 115 THE HALTER and `docs/spec/bosses.md` §11.53: `RestraintGate`'s first tenant, **every command either seat sends heard** and zeroing that seat's rest, counted in whole beats up to `halterRestThreshold`; and `halterChordLeft` and `halterChordRight` heard as THE TRIVET hears its pads, a mask a seat, on both seats. Which seat rests is the step's — on the left segment the navigator rests and the pilot grips, on the right the other way about, on a guard either. A beat counts only while the step's rester is settled, holding no grip, and the other seat holds both grips; `halterHoldBeats` together cracks the segment, and either half failing while they held clears both counters. Both cracks bare the centre, a fire step the ordinary shot into the middle column in its colour, a guard between the shots keeping the plating off it. Two cracks and three hits as the health. **Seven departures are argued by name** in §11.53: the eleven rows are seven steps, the rest is held at the threshold and zeroed as a step lights, a rester with a thumb on a grip is not resting, a segment run out is tried again, a guard's pairing is free, a guard comes apart the instant the pair does, and a fire step run out is the wave. The fourteen sounds are bound; nothing sends a grip from a touch yet, nothing of it is drawn, and there is no autopilot hand |
| [§32 THE SLING](#32-the-sling--a-draw-held-long-enough-to-loose-it-aimed) | **lane one landed, 26 September 2026** — the touch sender and lane two open | The simulation is in as wave 111 THE SLING and `docs/spec/bosses.md` §11.49: `slingDrawLeft` and `slingDrawRight`, one per seat by geometry, THE MANTLE's rule, each a drag whose `on: true` is the finger down and whose lift carries the swipe on `fromMilli` by its sign — `DrawRelease`, spending `HOLD, THEN SWIPE` for the first time; a script authored on the wave of two draws an arm, each toward an aim of `left` or `right`, then fire and `both` in turn; a draw counted on the beat while held and judged at the lift, a lift too soon, the wrong way or with no swipe springing the arm slack; the fourth draw lighting the yoke; a fire step the ordinary shot into the middle column in its colour. Four draws and three hits as the health. **Nine departures are argued by name** in §11.49: a fire step run out is the wave, the aim is authored as a side and the look picks the column, `DrawRelease` rides the drag, a draw run out is tried again, a draw is given grace, a finger down before the step lights is counted, a second draw run out relights the same step, the draws and the hits are the health together, and row 7's lost fire beats are the `both` step asked again. The twelve sounds are bound; nothing sends a draw from a touch yet (`apps/game` sends no `slingDraw*` drag), nothing of it is drawn, and there is no autopilot hand |
| [§31 THE PLUMB](#31-the-plumb--a-lean-held-long-enough-to-bring-it-level) | **lane one and the lean reader landed, 26 September 2026**; lane two's half one, the body, landed the same day — half two open | The simulation is in as wave 110 THE PLUMB and `docs/spec/bosses.md` §11.48: `plumbLevelLeft` and `plumbLevelRight`, one per seat by geometry, THE MANTLE's rule, each drag one reading whose `fromMilli` is the phone's lean — `LevelTilt`, spending `TILT, AS A LEVEL` for the first time — with `on: false` a phone not read; a script authored on the wave of two settles a weight, the second inside a narrower range, then fire and `both` in turn; a level counted on the beat and started again by the lean leaving the range; the fourth settle lighting the core; a fire step the ordinary shot into the middle column in its colour. Four settles and three hits as the health. **Nine departures are argued by name** in §11.48: a fire step run out is the wave, a level is given grace, the lean is recorded whenever the bob is present, `LevelTilt` rides the drag's `fromMilli`, the range is the step's, a level run out relights the same step, there is no break step, the settles and the hits are the health together, and row 7's lost fire beats are the `both` step asked again. The twelve sounds are bound. The phone's gamma goes out as the seat's own drag, one per half degree moved and only while a bob is on the field (`apps/game/src/lean.ts`), with iOS asked from the lift off THE PLUMB's READY; no desk key leans yet. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: THE WEIGHT's sac as a bob of old bronze on a hook over the middle column, a beam across it with THE POMMEL's balls on chains at its ends, the pilot's heavier, hanging lopsided and brought level a quarter per settle by a steady phone; a spirit level under each ball, lit while asked, its bubble at the phone's lean; the sac edge-on until both weights are true and turned face-on to show the core, lit in its colour with its ring closing, smaller and brighter per hit; the weights swaying off true as a `both` step runs out; and the bob swinging free (`render/plumb-shape.ts`, `plumb-pose.ts`, `plumb-draw.ts`, `plumb-marks.ts`, `test/plumb-frame.test.ts`). **Half two, the hands, is queued**: the fx, the cue's words, THE SLOW's aim and the autopilot hand |
| [§30 THE TRIVET](#30-the-trivet--three-feet-each-planted-only-while-a-chord-holds) | **lane one landed, 26 September 2026**; lane two's half one, the body, the chord on the field, the autopilot hand, THE SLOW's aim, the cue's words and the fx landed the same day and the lurch and the needle were drawn after them | The simulation is in as wave 109 THE TRIVET and `docs/spec/bosses.md` §11.47: `trivetPadFront` and `trivetPadRear`, one per seat by geometry, THE MANTLE's rule, each drag one pad by its `id` — `ChordHold`, spending `CHORD` for the first time — kept as a mask of the pads each seat holds; a script authored on the wave of two plants a foot, the second on three pads, then fire and `both` in turn; a chord counted on the beat and started again by any lit pad lifting; the fourth plant lighting the hub; a fire step the ordinary shot into the middle column in its colour. Four plants and three hits as the health. **Eight departures are argued by name** in §11.47: a fire step run out is the wave, a chord is given grace, the pads are recorded whenever the stand is present, `ChordHold` rides the drag's `id` as two masks, a chord run out relights the same step, there is no break step, the plants and the hits are the health together, and row 7's lost fire beats are the `both` step asked again. The twelve sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: SINKER's hub in dull gunmetal with one of CALTROP's needles run out to each foot as a leg; each outer foot on a plate of sockets lit a cold blue-white while a chord wants them and drawn pressed under a held pad; the foot swinging down by the share held and clamped at its ankle on the second plant; the hub dark, bare metal once both feet hold it, lit in its colour with its ring closing, smaller and brighter per hit; the feet creeping loose through a `both` step; and the collapse splaying the legs flat (`render/trivet-shape.ts`, `trivet-pose.ts`, `trivet-draw.ts`, `trivet-marks.ts`, `test/trivet-frame.test.ts`). **The pads on the field landed the same day**: a finger anywhere on a seat's side of the hub is one finger of a chord, counted as a pad by the order it landed in (`render/trivet-grip.ts`, `render/chord.ts`, `apps/game/src/chord.ts`), and **the autopilot hand** after it, holding each lit chord and shooting each lit hub, with the STATES sheet's four poses (`hands/boss-hands-trivet.ts`), **THE SLOW's aim** round the hub, as wide as the feet reach (`render/slow-boss-aim.ts`), and **the cue's words**: `HOLD` on each foot a lit chord asks for until it is down, and `FIRE` under the middle column while the hub is lit (`render/boss-cue-read-zh.ts`), and **the fx**: a plant thuds the stand down and through the plating, a clamp flares as it locks, a hub hit flashes wider per hit, the collapse flashes the hub and shudders the hull harder, a plant and a hit each deal the blow (`render/trivet-fx.ts`). Row 11's ring under the spent hub waits on §30's revised simulation lane, which queues its own look. **Two story steps landed later the same day** in the simulation: the lurch, a foot held while the swung hub is shot, and the needle, shielded under its column (§11.47), and drawn after them: the hub thrown over its column with the far foot up, the needle flung and sinking with its sight to the hull, and `HOLD`, `FIRE` and `SHIELD` on the field (`render/trivet-story.ts`) |
| [§29 THE RIME](#29-the-rime--a-level-nobody-has-to-hold-only-keep-re-reaching) | **lane one landed, 26 September 2026**; lane two's half one, the body, landed the same day — half two open | The simulation is in as wave 108 THE RIME and `docs/spec/bosses.md` §11.46: `rimeHalfLeft` and `rimeHalfRight`, one per seat by geometry, THE MANTLE's rule, each carrying `RubCount` — spent for the first time — as the drag's `id`; a script authored on the wave of two wipes a half, then fire and shield in turn; every fresh reversal on the lit half shaving `rimeShaveMilli` and a beat nobody rubbed it growing `rimeRegrowMilli` back; the fourth wipe baring the core; a fire step the ordinary shot into the middle column in its colour; a shield step SEAM's guard under the lens. Four wipes and three hits as the health. **Ten departures are argued by name** in §11.46: a fire step run out is the wave, a wipe run out retries from that half's first wipe, a surge run out asks the shield again rather than the wipes, the surge is SEAM's guard, frost regrows only on the lit half, the count rides the drag's `id` and the frosts are one pair, a wipe is answered on the tick, the film is config, the wipes and the hits are the health together, and there is no grace on a wipe. The twelve sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: BULB · PEBBLE's featureless outline as a pane of dull grey glass, split down the spine into the pilot's half and the navigator's, with THE CAIRN's seven faceted sheets laid over it as pale frost, seams left showing; a wiped half's clear patch as wide as its frost is gone; the lit half white and the other gone dull; a surge crawling in from the rim through a shield step; the core dark under the frost, lit in its colour with its ring closing once bared, smaller and brighter per hit; and the shatter dropping the seven sheets apart (`render/rime-shape.ts`, `rime-pose.ts`, `rime-draw.ts`, `rime-marks.ts`, `test/rime-frame.test.ts`). **Half two, the hands, is queued**: the grip, the autopilot hand, the fx and the flakes, the cue's words, THE SLOW's aim and row 11's refreeze film |
| [§28 THE VISE](#28-the-vise--a-gap-two-thumbs-close-from-opposite-sides) | **lane one landed, 26 September 2026**; lane two's half one, the pinch, the autopilot hand, the fx and the cue's words landed the same day — the look is done | The simulation is in as wave 107 THE VISE and `docs/spec/bosses.md` §11.45: `viseLobeLeft` and `viseLobeRight`, one per seat by geometry, THE MANTLE's rule, each carrying `SqueezeGap` — spent for the first time — as the drag's `fromMilli`; a script authored on the wave of two seams a lobe, then fire and both in turn; a pinch step counting the beats its gap stays at or under `viseShutMilli` and a gap widened back starting it again; the fourth seam baring the kernel; a fire step the ordinary shot into the middle column in its colour. Four seams and three hits as the health. **Eight departures are argued by name** in §11.45: a fire step run out is the wave, a pinch run out is tried again, row 7's hold open is both lobes pinched shut, there is no break step, a gap is recorded whenever the case is present, a pinch is given grace past its count, the seams and the hits are the health together, and the gap rides the drag rather than two fields of its own. The twelve sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: BULB · PEAR's hanging outline split down its long axis into the two lobes, with BULB · BURR's twelve-lobe bristle for an edge, in the field's only brown; each lobe a half-shell hinged at the top of the spine, standing open by its seams cracked and narrowed by the gap pinched on it; the lit seam white, cracking down from the top by the share held; a `both` step lighting the tight seam on each lobe and letting the lobes creep shut over the kernel as its window runs out; the kernel in shadow while covered, lit in its colour with its ring closing once bared, smaller and brighter per hit; and the split (`render/vise-shape.ts`, `vise-pose.ts`, `vise-draw.ts`, `vise-marks.ts`, `test/vise-frame.test.ts`). **Half two, the hands, is three lanes; the pinch landed 26 September 2026**: a press in a seat's zone takes hold silently, the second finger of the same seat pairs, and the gap between the fingertips less a fingertip's width is sent as `fromMilli` on every change; either lift lets go (`render/vise-grip.ts`, `render/pinch.ts`, `apps/game/src/pinch.ts`). The autopilot hand landed 26 September 2026 (`hands/boss-hands-vise.ts`). THE SLOW's aim landed the same day: the light stands round the whole case (`render/slow-boss-aim.ts`). The receipts landed the same day: a crack's dry thud down the plating, a sprung lobe ringing open, the kernel's flash wider per hit and the split's (`render/vise-fx.ts`). The cue's words landed the same day: `SHUT` on each lobe a lit pinch asks for until it is shut, and `FIRE` under the middle column while the kernel is lit (`render/boss-cue-read-zf.ts`) |
| [§27 THE OCULUS](#27-the-oculus--shutting-an-eye-together-then-answering-what-was-behind-it) | **lane one landed, 26 September 2026**; lane two, both halves, landed the same day | The simulation is in as wave 106 THE OCULUS and `docs/spec/bosses.md` §11.44: `oculusLeafLeft` and `oculusLeafRight`, one per seat by geometry, THE MANTLE's rule; a script authored on the wave of three shuts, the break, and fire and reseal in turn; a hold step counting the beats both leaves are down and a thumb lifted starting it again; a fire step the ordinary shot into the middle column in its colour. Six leaves and three hits as the health. **Six departures are argued by name** in §11.44: a fire step run out is the wave, a hold step run out is tried again, the break is a timed reveal with no THE SLOW, a leaf is recorded whenever the lens is present, a hold is given grace past its count, and the leaves and the hits are the health together. The twelve sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: THE SLATER — SHUT's lapped plates as the grey rim with THROB · CROWN's six pins on it, six dull glass iris blades swinging about them, the lit pair white and sliding shut as it is held, a reseal's pair cracked, the socket easing open at the break, the core lit in its colour with its ring closing and smaller per hit, and the shatter (`render/oculus-shape.ts`, `oculus-pose.ts`, `oculus-draw.ts`, `oculus-marks.ts`, `test/oculus-frame.test.ts`). **The on-field leaf holds landed 26 September 2026**: each seat's half of the lens is its leaf by geometry, on both phones (`render/oculus-grip.ts`), and AUTO's hand and the four STATES poses after them (`hands/boss-hands-oculus.ts`), and the receipts' fx the same day: the thud of a shut pair and a quieter reseal, a core hit's flash wider each time, the shatter's (`render/oculus-fx.ts`), and the cue's words the same day: `HOLD` on each seat's half of a lit pair, `FIRE` under the lit core (`render/boss-cue-read-ze.ts`). THE SLOW's light the same day stands round the lens rather than splitting it, from the first row of a table of bosses by kind (`render/slow-boss-aim.ts`). **Half two is done.** |
| [§26 THE SEAM](#26-the-seam--a-crack-the-cannon-answers-in-order-with-the-shield-in-between) | **lane one landed, 26 September 2026**; lane two's half one landed the same day — half two open | The simulation is in as wave 105 THE SEAM and `docs/spec/bosses.md` §11.43: a script authored on the wave, each step a point shot in its colour, grit taken on the shield under the ridge, a rock shot in its column, or grit and a rock at once — every answer a standard control, and each heard only inside its own step under THE SLOW. Three sealing points as the health. **Seven departures are argued by name** in §11.43: one sealing point per movement, row 5's pair as two steps, a miss is the wave, row 9's rock takes either colour, a guard must come after the step lit, the script is on the entry, and the shield is read every tick. The ten sounds are bound. **The story steps landed 26 September 2026**: the ridge turned away, grit thrown blind onto the shield, and a glow from within quenched by three shots of either colour — the script is eleven steps. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: THE RIND's three stepped lobes as the grey ridge, each shedding its teeth as its point seals, the crack wide at an open point and closed at a sealed one, the lit point in its colour with its ring closing, the grit, the rock in its column and colour, and the split (`render/seam-shape.ts`, `seam-pose.ts`, `seam-draw.ts`, `seam-marks.ts`, `test/seam-frame.test.ts`). **Half two, the hands, is queued**: the seal's click, the grit's spark, hurt, the cue's words, THE SLOW's aim and the autopilot hand |
| [§25 THE VALVE](#25-the-valve--freezing-what-the-other-hand-is-already-moving) | **lane one landed, 26 September 2026**; lane two's half one landed the same day — half two open | The simulation is in as wave 104 THE VALVE and `docs/spec/bosses.md` §11.42: `valveWheel`, THE HASP's bearing wheel turned by Player 1 alone onto a mark the wave authors, and `valvePin`, whose press by Player 2 on its edge is `FreezeTap` — spent for the first time — and whose draw by either seat, once frozen, pulls a pin. Three pins as the health, the freeze and pull windows shorter after the first, a spark leaked by the first pin, and a third movement whose mark counts only after a full lap. **Seven departures are argued by name** in §11.42: the turn carries no window, the lap is signed travel rather than a direction, the spark takes either colour and a miss is the wave, the spark falls through the list, the freeze is a press on a `DragTarget` rather than a new `Hold` kind, a lapse or thaw kicks the wheel off its mark, and a window opened mid-beat counts from the beat after. The thirteen sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: THE CODEX's notched iron drum, its rim scrolled by the wheel's bearing, THE TITHE's plates as the three pins, the wheel drawn where it stands, the white mark and socket with the open window's arc, and the list a step per pin out (`render/valve-shape.ts`, `valve-pose.ts`, `valve-draw.ts`, `valve-marks.ts`, `test/valve-frame.test.ts`). **Half two, the hands, is queued**: the grip, the fx, hurt, the cue's words and the autopilot hand |
| [§24 THE KEEL](#24-the-keel--whose-thumb-the-spine-calls-on-next) | **both lanes landed, 26 September 2026** | The simulation is in as wave 103 THE KEEL and `docs/spec/bosses.md` §11.41: one tap target, `keelJoint`, walking a six-segment spine, and whose tap it wants read off which half of the screen the lit segment sits on (`geometrySeat`, the spec's `GeometrySeat`, spent for the first time and held by the COPIES table). Six segments as the health, a socket at the midpoint answered by the cannon in the wave's colour, a fast third movement in the wave's own order (`reprise`) with no SLOW, and a rock from the tail. **Five departures are argued by name** in §11.41: a missed joint before the fast run costs only the beat, the third movement's order is authored rather than drawn, a missed socket is a hit on the hull, the rock takes either colour while the socket keeps its own, and the tail is the rightmost segment. The sixteen sounds are bound. Lane two, the look, is split in halves. **Half one, the body, landed 26 September 2026**: THE CANOPY's faceted arc laid with THE BRISTLE's squared-off lozenges, one per segment over its own column, ribs underneath; loose segments dull, sagging and swaying on their own count, locked ones lit and seamed white; the arch tightening as it locks; the lit joint's white ring and closing window; the midpoint's end-faces and the socket in the wave's colour; the tempo run's dim and re-light; the rigid hold, the whip, the rock and the snap straight (render/keel-shape.ts, keel-pose.ts, keel-draw.ts, keel-marks.ts, test/keel-frame.test.ts). **Half two, the hands, landed the same day**: the grip on `keelJoint`, the fx and the events off the silent lists, hurt, the cue's words and the autopilot hand (render/keel-grip.ts, keel-fx.ts, boss-cue-read-zd.ts, hands/boss-hands-keel.ts). **The story between, simulation only, landed the same day**: a flip both seats hold their end joints through (`CHORD`), a marrow sealed by a bolt of each colour up the middle, and a hands-off cooldown after the rock (`SENDING NOTHING`), in sim/keel-story.ts; the three pictures are the next lane |
...
| 3 | The gap under the sheared plates leaks light, a hairline crack races along the seam from it | — | — | — | — | — |
...
[bosses](bosses.md) §11.45, wave 107, with its look — §29 THE RIME — §11.46, wave 108 —
§30 THE TRIVET — §11.47, wave 109 — and §31 THE PLUMB — §11.48,
wave 110, with THE PLUMB's lean reader — §32 THE SLING — §11.49,
wave 111 — §33 THE GRINDSTONE — §11.50, wave 112 — §34 THE CYST —
§11.51, wave 113 — §35 THE DAVIT — §11.52, wave 114 — and §36 THE
HALTER — §11.53, wave 115 — their looks queued, and THE SLING's, THE
GRINDSTONE's, THE CYST's, THE DAVIT's and THE HALTER's touch senders with
them. Same split as
