...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — ninety-two of the hundred and three waves today, and a wave
...
**There are eighty-nine of them now**, one per guided wave bar three, and
...
and the two circles are **THE NETTLE, THE MANTLE and THE KEEL** — and
...
**All three of those are films nobody has written, and since THE
