...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — seventy-two of the eighty-one waves today, and a wave with
...
**There are fifty-nine of them now**, one per guided wave bar twelve, and each
is authored in `packages/content/src/scenes/` as a page of choreography rather
than a page of prose. The twelve that are still the three strings and the two
circles are **THE COUNT, THE CHOKE, THE LIMPET, THE LEECH, THE CODEX, THE MINE,
THE SCOUT, THE REPRISE, THE STARE, THE FLIP, THE DIASTOLE and THE BATON** —
...
**Seven of those twelve are films nobody has written, THE SCOUT's, THE
REPRISE's, THE STARE's, THE FLIP's, THE DIASTOLE's and THE BATON's are owed by
the lanes that draw them, and THE MINE is the one that cannot have one.** Every act of a rehearsal is a thumb landing on a *named*
