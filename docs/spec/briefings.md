...
> order.** A wave with a guide opens on it, and on all but three of them that is
...
> pass on a timer.
> §3.2 says which three are still prose and why the count is a test rather than
...
### 3.2 The rehearsals — all but three of them
...
**There are eighty-eight of them now**, one per guided wave bar three, and
each is authored in `packages/content/src/scenes/` as a page of choreography
rather than a page of prose. The three that are still the three strings
and the two circles are **THE RATCHET, THE NETTLE and THE MANTLE** — and
...
**Every one of those three is a film nobody has written, and since THE
