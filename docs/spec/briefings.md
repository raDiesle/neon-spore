...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — sixty-six of the seventy-five waves today, and a wave with
...
**There are fifty-nine of them now**, one per guided wave bar seven, and each is
...
are **THE COUNT, THE CHOKE, THE LIMPET, THE LEECH, THE CODEX, THE MINE and THE
SCOUT** —
...
**Five of those seven are films nobody has written, THE SCOUT's is owed by the
lane that draws it, and THE MINE is the one that cannot have one.** Every act of a rehearsal is a thumb landing on a *named*
