...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — eighty of the eighty-nine waves today, and a wave
...
**There are sixty of them now**, one per guided wave bar twenty, and each
...
TASTER and THE SINEW** — and that list is held by
...
CURTAIN's, THE TASTER's and THE SINEW's are owed by the lanes that draw them.**
