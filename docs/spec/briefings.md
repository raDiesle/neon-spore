...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — seventy-three of the eighty-two waves today, and a wave with
...
**There are fifty-nine of them now**, one per guided wave bar fourteen, and each
...
THROAT and THE HUSK** — and that list is held by `test/scenes-prose.test.ts`
...
**Five of those fourteen are films nobody has written, THE SCOUT's, THE
REPRISE's, THE STARE's, THE FLIP's, THE DIASTOLE's, THE BATON's, THE THROAT's
and THE HUSK's are owed by the lanes that draw them, and THE MINE is the one
