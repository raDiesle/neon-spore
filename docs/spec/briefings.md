...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — seventy-nine of the eighty-eight waves today, and a wave
...
**There are sixty of them now**, one per guided wave bar nineteen, and each
is authored in `packages/content/src/scenes/` as a page of choreography rather
than a page of prose. The nineteen that are still the three strings and the two
...
THE HUSK, THE UNDERTOW, THE ORRERY, THE CANDLE, THE GORGE, THE CURTAIN and THE
TASTER** — and that list is held by
...
CURTAIN's and THE TASTER's are owed by the lanes that draw them.** THE MINE
