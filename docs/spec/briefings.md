...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — seventy-six of the eighty-five waves today, and a wave with
...
**There are sixty of them now**, one per guided wave bar sixteen, and each
is authored in `packages/content/src/scenes/` as a page of choreography rather
than a page of prose. The sixteen that are still the three strings and the two
...
THE HUSK, THE UNDERTOW, THE ORRERY and THE CANDLE** — and that list is held by
...
**Every one of those sixteen is a film nobody has written, and THE SCOUT's, THE
REPRISE's, THE STARE's, THE FLIP's, THE DIASTOLE's, THE BATON's, THE THROAT's,
THE HUSK's, THE UNDERTOW's, THE ORRERY's and THE CANDLE's are owed by the lanes that draw them.** THE MINE
