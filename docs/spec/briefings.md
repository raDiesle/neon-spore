...
1. **The guide**, if the wave carries one — and it is *first*. A concrete
   ...
   new carries one — ninety-three of the hundred and four waves today, and a wave
...
**There are eighty-nine of them now**, one per guided wave bar four, and
...
and the two circles are **THE NETTLE, THE MANTLE, THE KEEL and THE VALVE** — and
...
**All four of those are films nobody has written, and since THE
