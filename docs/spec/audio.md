...
| `boss` | the bosses that are built, and the names holding a slot | 204 of 213 |
...
108 of the 397 are `spare`: finished, tested, and nothing plays them. That is
