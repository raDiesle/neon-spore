...
| `boss` | the bosses that are built, and the names holding a slot | 40 of 49 |
...
109 of the 231 are `spare`: finished, tested, and nothing plays them. That is
...
`bind-fence.ts`, `bind-baton.ts`, `bind-warden.ts`,
