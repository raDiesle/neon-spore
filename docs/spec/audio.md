...
| `boss` | the bosses that are built, and the names holding a slot | 242 of 251 |
...
108 of the 435 are `spare`: finished, tested, and nothing plays them. That is
