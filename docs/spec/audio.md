...
| `boss` | the bosses that are built, and the names holding a slot | 216 of 225 |
...
108 of the 409 are `spare`: finished, tested, and nothing plays them. That is
