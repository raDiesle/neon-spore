...
| `boss` | the bosses that are built, and the names holding a slot | 207 of 216 |
...
108 of the 400 are `spare`: finished, tested, and nothing plays them. That is
