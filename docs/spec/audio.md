...
| `boss` | the bosses that are built, and the names holding a slot | 213 of 222 |
...
108 of the 406 are `spare`: finished, tested, and nothing plays them. That is
