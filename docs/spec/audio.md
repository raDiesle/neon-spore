...
| `boss` | the bosses that are built, and the names holding a slot | 246 of 255 |
...
108 of the 439 are `spare`: finished, tested, and nothing plays them. That is
