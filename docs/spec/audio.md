...
| `boss` | the bosses that are built, and the names holding a slot | 49 of 58 |
...
109 of the 242 are `spare`: finished, tested, and nothing plays them. That is
...
`bind-fence.ts`, `bind-baton.ts`, `bind-undertow.ts`, `bind-warden.ts`,
