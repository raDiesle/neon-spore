...
| `boss` | the bosses that are built, and the names holding a slot | 210 of 219 |
...
108 of the 403 are `spare`: finished, tested, and nothing plays them. That is
