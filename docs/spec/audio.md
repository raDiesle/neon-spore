...
| `boss` | the bosses that are built, and the names holding a slot | 219 of 228 |
...
108 of the 412 are `spare`: finished, tested, and nothing plays them. That is
