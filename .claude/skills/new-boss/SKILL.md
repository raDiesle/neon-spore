...
**So this is detail and not choreography**, and it is the one place §5's
standard is deliberately not asked for: no pose per state, no morph, no change
of perspective. The state the boss has today is the state to draw, drawn until
