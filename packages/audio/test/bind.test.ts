...
const SAMPLES: Record<string, SimEvent> = {
  ...
  bellowsEnter: { type: "bellowsEnter", col: 3 },
  bellowsMarks: { type: "bellowsMarks", col: 3, seams: 3 },
  bellowsPulled: { type: "bellowsPulled", col: 3 },
  bellowsSeam: { type: "bellowsSeam", col: 3, seams: 2 },
  bellowsJam: { type: "bellowsJam", col: 3, player: 1 },
  bellowsLate: { type: "bellowsLate", col: 3 },
  bellowsSpark: { type: "bellowsSpark", col: 3 },
  bellowsSparkOut: { type: "bellowsSparkOut", col: 3 },
  bellowsSparkHit: { type: "bellowsSparkHit", col: 3 },
  bellowsBreath: { type: "bellowsBreath", col: 3 },
  bellowsGlow: { type: "bellowsGlow", col: 3 },
  bellowsGrip: { type: "bellowsGrip", col: 3, player: 2 },
  bellowsSplit: { type: "bellowsSplit", col: 3 },
  bellowsHold: { type: "bellowsHold", col: 3 },
  bellowsVent: { type: "bellowsVent", col: 3 },
  bellowsOut: { type: "bellowsOut", col: 3 },
