...
export const HULL_SOUNDS: SoundDef[] = [
  ...
  },
  {
    ...
    status: "bound",
    use: "A hit: the wave is lost, and the field stands still for the retry.",
    level: 0.34,
    pierce: "The wave is gone. There is one thing left to say, and this is it saying it.",
  ...
  },
  {
    ...
    status: "spare",
    use: "Was the mend pod taken in; the hull has no points to mend since 12 September 2026, and the plain pod went with them.",
    level: 0.4,
    layers: [
