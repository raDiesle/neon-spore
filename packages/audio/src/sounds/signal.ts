...
export const SIGNAL_SOUNDS: SoundDef[] = [
  ...
  },
  {
    ...
    status: "bound",
    use: "THE WISP hopping (`wispHop`) — unpanned and unpitched, because the tile is exactly what the other seat must not be told. It was written for a coordinate grid and this is the mechanic that finally brought one.",
    level: 0.26,
