 ...
 * giving way, the second bead and the merge, the crossing — an act a beat to
 * the end, or the whole arm back — and the drop out of the last socket into
 * the maw.
 */
