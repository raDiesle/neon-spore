...
import { fieldHandsHeard } from "./field-hands.js";
...
import { stepLidPulls } from "./lid.js";
...
export function step(world: World, commands: readonly TimedCommand[]): void {
  ...
  // Every hand on the field, each read on the tick for a reason of its own
  // written beside it (`field-hands.ts`).
  fieldHandsHeard(world, commands);
