import { tailHashParts } from "./hash-creature-tail.js";
 ...
 * is here, and a new field is appended at the bottom of the last file in the
 * chain — which is `hash-creature-tail.ts` now, cut off the end of this one
 * on the same terms when THE CRYSTAL's leg took it past the limit.
 *
