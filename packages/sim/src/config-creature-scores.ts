...
export interface CreatureScoreConfig {
  ...
  /** What THE COUNT is worth on zero, in its colour. `scoreThrobHit`'s figure:
   * the other body the pair can only reach by saying a moment out loud. */
  scoreCountdownKill: number;
}
