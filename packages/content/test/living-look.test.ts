...
import { BANK } from "../src/motion-bank.js";
import { HOLD, POISE } from "../src/motions.js";
import { BLOOM } from "../src/motions-event.js";
...
describe("the living-look table", () => {
   ...
   */
  it("counts exactly the six bodies the field draws through drawLiving", () => {
    expect(livingBodyKinds()).toEqual(["slick", "bulb", "throb", "dart", "wisp", "beatbox"]);
  });
