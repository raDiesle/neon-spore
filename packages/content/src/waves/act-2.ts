...
export const WAVES_ACT_2: Wave[] = [
  ...
  },
  {
    ...
    guide: {
      both: "Open the hatch and shoot the eye. One plate off the rim per hit. Five hits.",
      p1: "1. Slide the cannon under the eye.\n2. Take the handle on the rope and pull it aside. Keep pulling.\n3. Say OPEN when the hatch is all the way over, and hold.",
      p2: "1. Load the rim's colour.\n2. Wait for OPEN.\n3. Fire once, up the eye's column.\n4. Say HIT. The rope snaps back: start again.",
      scene: "theWarden",
    },
    entries: [],
    boss: { kind: "warden" },
