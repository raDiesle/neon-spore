...
export const CREATURE_HUES = {
  /**
   * THE CLASP's shield, and the one deliberate exception to the rule on `good` (`palette.ts`).
   *
   ...
   *
   * The rule stated on `good` is that nothing else is ever green, and this
   ...
   */
  throbMiddle: "#3A3940",
  /** THE VISE's seed-case (§28, *Colour*): the field's only brown, its shadow, and its cracks' dry white. */
  viseCase: "#9C7A52",
  viseCaseDark: "#35271A",
  viseCrack: "#E6DCC6",
  /**
