import { drawAxes } from "./coord-axes.js";
...
/**
 * The three names, re-exported from `coord-axes.ts` where they live beside the
 * only thing that draws them. Here because this is the file the rest of the
 * repository already imports them from, and a move that renamed an import at
 * four call sites would be a move nobody could see the point of.
 */
export { colLabel, colNumber, rowLabel } from "./coord-axes.js";
