...
// And a finger moved, whose answer is one per kind of hold (`touch-move.ts`).
export { touchMove } from "./touch-move.js";

import { bandUnder } from "./touch-band.js";
import { dragging } from "./touch-drag.js";
...
import { wellSucksOnLift, wellUnder } from "./touch-well.js";
