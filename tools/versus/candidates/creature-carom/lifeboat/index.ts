...
import { lifeboat } from "./paint.js";

/**
 * `creature:carom` / `lifeboat` — FACET taken on as a space rescue capsule.
 *
 ...
 */
export const CAROM_LIFEBOAT: Variant = {
  slot: "creature:carom",
  name: "lifeboat",
  sentence:
    "every face behind the scorched nose a band of the rescue stripe from silhouette to glass — white and dark by turns, symmetric about the tail — two rivets a face along the ridge, and a larger beacon that throws a cone of the body's colour off the tail on the beat",
  dir: "tools/versus/candidates/creature-carom/lifeboat",
  patches: [
    patch({
      ...
      // the travel.
      fields: { shell: lifeboat, travel: wedge },
    }),
  ],
};
