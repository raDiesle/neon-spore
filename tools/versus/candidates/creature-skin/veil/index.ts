 ...
 * argument to `lit`. LIT says a creature should be a solid under a light and
 * fills it with flesh to get one. VEIL says the near-background deep is
 ...
 * where LIT is the membrane row, and the two of them are a real choice rather
