...
import type { ChoirDraw } from "../../../../../packages/render/src/choir-look.js";
import { choirVoiceAt, VOICES } from "../../../../../packages/render/src/choir-shape.js";
import { halo } from "../../../../../packages/render/src/glow.js";
import { rgba } from "../../../../../packages/render/src/hex.js";
import { PALETTE } from "../../../../../packages/render/src/palette.js";

/**
 * The paint ORBS is made of, kept out of `index.ts` so that file stays the
 ...
 * shading pass that darkened the inside of a voice would be answering the
 * wrong question however round it made the body. Light is added where the
 * surface faces the light and simply not added where it does not, which is how
 * a soap bubble is lit and is why this can claim to be *more* see-through than
 * the wash it is offered against.
 */
 ...
 * **this candidate's number**, not a second copy of either of theirs. A voice
...
const PINS: Pin[] = Array.from({ length: CELLS }, (_, i) =>
...
/**
 * The whole pass: the two halos the shipped film throws, two bubbles under
 * them, and the membrane's own rim over the top with no wash inside it.
 */
export function orbs(d: ChoirDraw): void {
