...
export const NO_SUBJECT_D: Record<string, string> = {
  ...
  // THE HALTER's fourteen: a seam over the field, the same argument.
  "boss.halterEnter": "the seam settling in over the field. A fixture, not a body on a grid.",
  "boss.halterLight": "a step lighting on the seam. Same argument.",
  "boss.halterSettle": "a seat gone still enough, which is an absence and no body. Same argument.",
  "boss.halterStartle": "a settled seat touching something. Same argument.",
  "boss.halterSlip": "a grip let go while the pair held. Same argument.",
  "boss.halterCrack": "a segment of the seam cracking open. Same argument.",
  "boss.halterBare": "the centre showing. Same argument.",
  "boss.halterGuard": "the centre held bare. Same argument.",
  "boss.halterShut": "a window run out, the seam flinching shut. Same argument.",
  "boss.halterSeal": "the centre covered again. Same argument.",
  "boss.halterHit": "a shot into the centre. Same argument.",
  "boss.halterMiss": "a fire step unanswered, on the hull, which the hull's own sounds have.",
  "boss.halterSplit": "the seam splitting, spent. Same argument.",
  "boss.halterOut": "the seam gone and the wave ending. Same argument, and an absence.",
};
