...
export const FIELD_GROUP: Record<keyof SimConfig, GroupName> = {
  ...
  damageCrawlerBite: "THE CRAWLER — a worm that walks the ship instead of falling",
  damageCrawlerSegment: "THE CRAWLER — a worm that walks the ship instead of falling",
  ...
  grateGaps: "THE GRATE — a live line with a way through it",
  grateGapCols: "THE GRATE — a live line with a way through it",
  grateDamage: "THE GRATE — a live line with a way through it",
