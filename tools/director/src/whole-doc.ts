/**
 * The tab that renders one document whole — PARTY GAMES
 * (`docs/party-games.md`).
 *
 ...
 * is a study of games that are not it, and its argument lives in a table
 ...
 *
 * It has one caller, and had four: TOWER DEFENCE, CLAUDE VS CHATGPT and
 * BORROWED were tabs here until the owner took them off the sheet. The next
 * whole document is still a container id and a route.
 */
