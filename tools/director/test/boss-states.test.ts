...
const OWED: Partial<Record<BossKind, readonly string[]>> = {
  ...
  maze: ["travel"],
  gauge: ["verdict", "spent"],
  // The field and clock bosses' states the pair's hands bring on.
  warden: ["narrow", "glare"],
  vane: ["veer", "seize"],
  fleet: ["struck", "sunk"],
  ...
  diastole: ["two", "alone", "burst"],
  baton: ["crossing", "falling", "down"],
  throat: ["slide", "quick", "open", "everts"],
  undertow: ["taken"],
  orrery: ["spitting", "naked", "out"],
  candle: ["eating", "last", "out"],
  gorge: ["spitting", "gorged", "out"],
  curtain: ["soft", "bare", "torn", "out"],
  taster: ["fanning", "hurrying", "closed", "out"],
  sinew: ["held", "swinging", "falling", "out"],
  ledger: ["paying", "whipping", "taut", "out"],
  surge: ["band", "sealing", "everting", "out"],
  lead: ["running", "still", "passing", "down"],
  scuttle: ["winding", "down"],
  antiphon: ["still", "down"],
  hive: ["spilling", "down"],
  instar: ["land", "down"],
};
