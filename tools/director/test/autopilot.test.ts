 ...
 * MANTLE, THE KEEL, THE VALVE, THE SEAM and THE OCULUS are here for its own reason — only its simulation lane has landed
 * (`docs/spec/bosses.md` §11.40–§11.44), and an autopilot hand plays a boss against
 * poses that do not exist yet. A new boss is a row in `AUTOPILOT_HANDS` or a
 * name here.
 */
const NO_HAND = new Set(["mantle", "keel", "valve", "seam", "oculus"]);
