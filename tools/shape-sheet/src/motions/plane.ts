...
/**
 * The spare motions that happen in the picture plane.
 *
 * These eleven are the folder's original contents, moved here unchanged when
 * `depth.ts` arrived beside them; `index.ts` says what the split is for. Every
 * one of them is a body being pushed around a flat page — swung, shivered,
 * spun, dropped — and none of them claims a third dimension.
 *
